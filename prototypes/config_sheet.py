...
main() only deletes/recreates "Config" tab — other tabs are preserved.

Run standalone:  uv run prototypes/config_sheet.py
...
# ── private config (real account numbers) ─────────────────────────────────────
...
ACCOUNTS = [
    ("Joint Salary",    _acct("Joint Salary"),    "income",   "Salary lands here; transfers out monthly"),
    ("Shared Card",     _acct("Shared Card"),     "spending",  "Day-to-day flex spending"),
    ("Shared Bill",     _acct("Shared Bill"),     "spending",  "Fixed bills (electricity, internet, gym)"),
    ("Shared Credit",   _acct("Shared Credit"),   "spending",  "Credit card — settled monthly"),
    ("Personal",        _acct("Personal"),        "spending",  "Andreas personal spending"),
    ("House & Ins.",    _acct("House & Ins."),    "loan",      "House loan + home insurance"),
    ("Car Loan",        _acct("Car Loan"),        "loan",      "Car loan repayments"),
    ("Saving-General",  _acct("Saving-General"),  "savings",   "General savings"),
    ("Saving-Vacation", _acct("Saving-Vacation"), "savings",   "Vacation savings"),
    ("Saving-House",    _acct("Saving-House"),    "savings",   "House savings"),
    ("Pets Fund",       _acct("Pets Fund"),       "savings",   "Pets emergency/savings"),
    ("SOS",             _acct("SOS"),             "savings",   "Emergency fund"),
    ("Liana",           _acct("Liana"),           "savings",   "Liana's fund"),
    ("Baby",            _acct("Baby"),            "savings",   "Baby/Minis fund"),
]
...
def build_config(sid, sheet_name):
    ...
    val.append(dropdown(sid, tx_start, tx_end, 1, acct_names_a1))
    val.append(dropdown(sid, tx_start, tx_end, 4, acct_names_a1))
...
def main():
    ...
    # Only delete/recreate "Config" — other tabs are preserved
    ...
    print(f"\nDone — '{SHEET_NAME}' (other tabs preserved)")
